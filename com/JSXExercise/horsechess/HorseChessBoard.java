package com.JSXExercise.horsechess;
...
public class HorseChessBoard {
    ...
    private static boolean[] visited = new boolean[X * Y]; //记录某给位置是否走过
    ...
    //写一个方法,对 ps 的各个位置, 可以走的下一个位置的次数进行排序, 把可能走的下一个位置从小到大进行排序
    ...
    //编写最核心的算法, 遍历期盼, 如果遍历成功, 就把finished 设置为true,
