...
-- 班级class(班号classid, 专业名subject, 系名deptname, 入学年份enrolltime, 人数num)
CREATE TABLE `class` (
...
INSERT INTO jsx_student VALUES(8101,'张三',18,101);
INSERT INTO jsx_student VALUES(8102,'钱四',16,121);
INSERT INTO jsx_student VALUES(8103,'王玲',17,131);
INSERT INTO jsx_student VALUES(8105,'李飞',19,102);
INSERT INTO jsx_student VALUES(8109,'赵四',18,141);
INSERT INTO jsx_student VALUES(8110,'李可',20,142);
INSERT INTO jsx_student VALUES(8201,'张飞',18,111);
INSERT INTO jsx_student VALUES(8302,'周瑜',16,112);
INSERT INTO jsx_student VALUES(8203,'王亮',17,111);
INSERT INTO jsx_student VALUES(8305,'董庆',19,102);
INSERT INTO jsx_student VALUES(8409,'赵龙',18,101);

SELECT * FROM department;
SELECT * FROM class;
SELECT * FROM jsx_student;

-- 3. 完成一下查询功能
--  3.1 找出所有姓李的学生
--  查表 jsx_student, like
SELECT * FROM jsx_student WHERE `name` LIKE '李%';
...
-- 2. 将上面的结果看成一个临时表和department联合查询即可		
SELECT tmp.*, department.departmentid FROM department, (
				SELECT SUM(num) AS nums, deptname
				FROM class
				GROUP BY deptname
				HAVING nums >= 30
)	tmp	WHERE department.deptname = tmp.deptname;

-- 4. 学校又新增加了一个物理系，编号为006
-- 添加一条数据
INSERT INTO department VALUES('000', '物理系');
-- 5. 学生张三退学，请更新相关的表
...
UPDATE class SET num = num -1 
			WHERE classid = (SELECT classid FROM jsx_student WHERE `name` = '张三');
-- 将张三从学生表中删除
DELETE FROM jsx_student WHERE `name` = '张三';		
-- 提交事务
COMMIT;	
