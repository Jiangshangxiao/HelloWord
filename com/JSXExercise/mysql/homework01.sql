...
SELECT ename, job FROM emp WHERE (deptno = 10 OR deptno = 30) AND sal > 1500;
-- (5) 显示无管理者的雇员名及岗位。
...
SELECT ename, job, hiredate FROM emp WHERE hiredate >= '1991-02-01' AND hiredate <= '1991-05-01'
						ORDER BY hiredate;

-- (2) 显示获得补助的所有雇员名,工资及补助,并以工资降序排序
SELECT ename, sal, comm FROM emp WHERE hiredate >= '1991-02-01' AND hiredate <= '1991-05-01'
						ORDER BY sal DESC;